#!/bin/bash
#SBATCH --job-name=vn_jc_4g
#SBATCH --partition=radiology,a100_short
#SBATCH --gres=gpu:4
#SBATCH --ntasks-per-node=4
#SBATCH --cpus-per-task=8
#SBATCH --mem=256G
#SBATCH --time=2-00:00:00
#SBATCH --output=runs/joint_contrast_random_4x5x6x_4gpu_%j.out
...
torchrun --nproc_per_node=4 scripts/train.py \
    ...
    --resume runs/joint_contrast_random_4x5x6x/last.pt \
    --epochs 30
